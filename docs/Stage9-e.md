...
**Текущая реализация:**
- `src/main/java/thaumcraft/common/config/research/ConfigResearch.java:3`-`src/main/java/thaumcraft/common/config/research/ConfigResearch.java:7`
...
- Files to change: `src/main/java/thaumcraft/common/config/ConfigRecipes.java`, `src/main/java/thaumcraft/common/config/research/ConfigResearch.java` (kernel) and the 6 category slice files (`ConfigResearchBasics.java`, `ConfigResearchAlchemy.java`, `ConfigResearchArtifice.java`, `ConfigResearchThaumaturgy.java`, `ConfigResearchGolemancy.java`, `ConfigResearchEldritch.java`), possibly recipe classes under `src/main/java/thaumcraft/api/crafting/**` and `src/main/java/thaumcraft/common/lib/crafting/**` only for key alignment.
...
- Files/classes to change: `src/main/java/thaumcraft/common/lib/research/ResearchManager.java`, `src/main/java/thaumcraft/common/lib/research/ScanManager.java`, `src/main/java/thaumcraft/common/config/research/ConfigResearch.java` (kernel) and its 6 category slice files (`ConfigResearchBasics.java`, `ConfigResearchAlchemy.java`, `ConfigResearchArtifice.java`, `ConfigResearchThaumaturgy.java`, `ConfigResearchGolemancy.java`, `ConfigResearchEldritch.java`).
...
**Текущая реализация:**
- `src/main/java/thaumcraft/common/config/research/ConfigResearch.java` (kernel) + 6 category slice files (`ConfigResearchBasics.java`, `ConfigResearchAlchemy.java`, `ConfigResearchArtifice.java`, `ConfigResearchThaumaturgy.java`, `ConfigResearchGolemancy.java`, `ConfigResearchEldritch.java`) — partial category+entry baseline across all 7 files.
