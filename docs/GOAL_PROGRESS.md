...
- Latest Stage 8-c alchemy-furnace follow-up moves the static advanced furnace body and tank-panel shell into `blockstonedevice_0`, leaving `TileAlchemyFurnaceAdvancedRenderer` responsible only for dynamic lava-panel and heat-glow paths; checkpoint validation is in progress.
