...
| 4 | Blocks + Tile Entities | ⚠️ **Partial: registered block set + metadata/harvest work; container hard-lock pass done; crucible/TE systems pending** |
...
| 3r-6r | Remediation (see docs/REPAIR.md) | ⚠️ **Active pre-Phase8 mine list; container and Phase 3 core baseline closed; remaining P0 items still block Phase 8** |
